...
Pre-built standalone single-file executables are available for Windows x64 users under **[Releases](https://github.com/your-username/VideoConverter/releases)**.

#### Quick Start Instructions:
1. **Download & Extract Release**: Download `VideoConverter_win64_v2.0.zip` from the [GitHub Releases](https://github.com/your-username/VideoConverter/releases/tag/v2.0) page and extract it.
